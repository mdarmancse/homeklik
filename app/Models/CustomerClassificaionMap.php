...
class CustomerClassificaionMap extends Model
{
    protected $DBGroup          = 'default';
    protected $table            = 'customer_classification_map';
    protected $primaryKey       = 'id';
    protected $useAutoIncrement = true;
    protected $returnType       = 'array';
    protected $useSoftDeletes   = false;
    protected $protectFields    = true;
    protected $allowedFields    = ['id','classification_id','realtor_id','visit_status_id','number','created_at','updated_at','deleted_at'];
