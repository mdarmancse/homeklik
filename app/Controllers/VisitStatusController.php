...
class VisitStatusController extends BaseController
{
    use ResponseTrait;
    protected $format    = 'json';
    public function index()
    {
        return view('backend/visit_status/view');
    }
    public function add()
    {
        return view('backend/visit_status/add');
    }
    public function store()
    {
        ...
        if ($this->request->getVar('name') != "")
        {
            ...
            if($ID)
            {
                ...
                return redirect()->to('/visit_status/');
            }
        }
        else
        {
    ...
    public function edit($model_id){
        ...
        return view('backend/visit_status//edit',$data);
    }
    ...
    public function ajaxView()
    {
        ...
        foreach ($data as $row) {
            $action = '<a class="btn btn-sm btn-space btn-success"" href="'.base_url('visit_status/edit/'.$row['id']) . '"><i class="fa fa-edit"></i>Edit</a>';
