                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Realtor Edit</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><i class="fas fa-tachometer-alt "></i><a href="<?php echo site_url('/') ?>" class="breadcrumb-link"> Dashboard</a></li>
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Realtor Edit</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        Realtor Edit
                                    ...
                                    <div class="card-body">
                                        <form action="<?= base_url('realtor/update') ?>" data-parsley-validate="" novalidate=""  method="post">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div  class="col-md-6">
                                                    <input name="entity_id" type="hidden" value="<?= $data['id']; ?>" class="form-control">
                                                        <input type="text" name="name"  placeholder="Enter Realtor Name"  value="<?= $data['name'] ?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input type="text" name="username" oninput="checkUsername(this.value)" onblur="checkUsername(this.value)"  placeholder="Enter Realtor User Name"  value="<?= $data['username'] ?>" class="form-control" required>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input name="rico" type="text" placeholder="Enter RICO" value="<?= $data['rico'] ?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input name="registration_date" type="date" placeholder="Enter RICO Registration Date" value="<?php echo date('Y-m-d', strtotime($data['registration_date'])); ?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input name="postal_code" type="text" placeholder="Enter Postal Code" value="<?= $data['postal_code'] ?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input name="board_name" type="text" placeholder="Enter Board Name" value="<?= $data['board_name'] ?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input name="street_number" type="textarea" placeholder="Enter Street Number" value="<?= $data['street_number'] ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input name="street_address1" type="textarea" placeholder="Enter Street Address" value="<?= $data['street_address1'] ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input name="street_address2" type="textarea" placeholder="Enter Additional Street Address" value="<?= $data['street_address2'] ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input name="unit" type="text" placeholder="Enter Unit" value="<?= $data['unit'] ?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                    <select name="province" class="form-control" id="input-select" required>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div  class="col-md-6">
                                                    <select name="city" class="form-control" id="input-select" required>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input name="mobile" placeholder="Enter Your Mobile Number" type="text" value="<?= $data['mobile'] ?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-6">
                                                        <input placeholder="Enter Email" required="" data-parsley-type="email" oninput="checkEmail(this.value)" onblur="checkEmail(this.value)" name="email" type="email" id="email" value="<?= $data['email'] ?>" class="form-control">
                                                        <br> 
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <select required="" name="brokerage_id" id="brokerage_id" class="form-control form-filter input-sm">
                                                        ...
                                                        foreach ($brokerages as $key => $value) { ?>
                                                            <?php if($value['id'] == $data['brokerage_id']){?>
