                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">City Edit</h2>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        City Edit
                                    ...
                                    <div class="card-body">
                                        <form action="<?= base_url('city/update') ?>" data-parsley-validate="" novalidate="" method="post">
                                        
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                        <label style="font-size: 16px;" class="col-form-label"><b>City Name</b></label>
                                                    </div>
                                                    <div  class="col-md-6">
                                                        <input  name="name" required placeholder="Enter City Name" type="text" value="<?= $name; ?>" class="form-control" required>
                                                        <input name="entity_id" type="hidden" value="<?= $id; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                        <label style="font-size: 16px;" class="col-form-label"><b>Latitude</b></label>
                                                    </div>
                                                    <div  class="col-md-6">
                                                        <input required name="latitude" id="latitude" placeholder="Enter Latitude" type="text" value="<?= $latitude ?>" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                        <label style="font-size: 16px;" class="col-form-label"><b>Longitude</b></label>
                                                    </div>
                                                    <div  class="col-md-6">
                                                        <input  required name="longitude" id="longitude" placeholder="Enter Longitude" type="text" value="<?= $longitude ?>" class="form-control" required>
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <label class="custom-control custom-checkbox">
                                                        <input  name="is_featured" <?php echo (isset($is_featured) && $is_featured == 1)  ? 'checked' : '' ?> value="1" type="checkbox" class="custom-control-input"><span class="custom-control-label"></span>
                                                    </label>
                                                    </div>
                                                </div>
