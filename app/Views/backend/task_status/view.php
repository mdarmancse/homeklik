                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Task Status</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><i class="fas fa-tachometer-alt "></i><a href="<?php echo site_url('/') ?>" class="breadcrumb-link"> Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-fw fa-building"></i> Task Status </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                                ...
                                <div class="modal fade" id="add_city" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Task Status Add</h5>
                    ...
                    <div class="modal fade" id="edit_city" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Task Status Edit</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <h3 class="card-header d-flex justify-content-between align-items-center">
                            Task Status 
                                ...
                                <a type="button" class="btn btn-sm btn-success" href="<?php echo site_url('/task_status/add') ?>">Add Task Status</a>
...
$(function(){
 ...
 <script>
            ...
            callback: function(dsiableConfirm) {
                if (dsiableConfirm) {
                    jQuery.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "<?php echo base_url('task_status/status/') ?>"+entity_id + "/" + status,
                        data: {
                            'entity_id': entity_id,
                            'status': status 
                        },
            ...
            callback: function(deleteConfirm) {
                if (deleteConfirm) {
                    jQuery.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "<?php echo base_url('task_status/delete/') ?>"+entity_id,
                        data: {
                            'entity_id': entity_id
                        },
                        success: function(response) {
    ...
    $(document).ready(function() {
        $('#city_ajax').DataTable({
            ajax: {
                url: "<?php echo base_url('task_status/getAjaxData'); ?>",
                type: 'POST',
                dataType: 'json',
                dataSrc: ''
            },
