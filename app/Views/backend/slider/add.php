                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><i class="fas fa-tachometer-alt "></i><a href="<?php echo site_url('/') ?>" class="breadcrumb-link"> Dashboard</a></li>
                                        <li class="breadcrumb-item"><i class="fa fa-fw fa-image"></i><a href="<?php echo site_url('/slider') ?>" class="breadcrumb-link">Slider</a></li> 
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        Slider Image Add
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo base_url('slider/store');?>" enctype="multipart/form-data" data-parsley-validate="" novalidate="" method="post">
                                        
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                        <label style="font-size: 16px;" class="col-form-label"><b>Slider Image</b></label>
                                                    </div>
                                                    <div  class="col-md-6">
