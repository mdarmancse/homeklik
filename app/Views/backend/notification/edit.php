                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Notification Edit</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><i class="fas fa-tachometer-alt "></i><a href="<?php echo site_url('/') ?>" class="breadcrumb-link"> Dashboard</a></li>
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Notification Edit</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        Notification Edit
                                    ...
                                    <div class="card-body">
                                        <form action="<?= base_url('notification/update') ?>" enctype="multipart/form-data" method="post">
                                                <div class="row form-group"  id="user_type_div">
                                                    ...
                                                    <div  class="col-md-6">
                                                    <select name="selection_type" class="form-control" id="selection_type" onchange="getUserType(this.value)">
                                                        <option value="">Select</option>
                                                        <?php $user_types = user_type();
                                                        if (!empty($user_types)) {
                                                            foreach ($user_types as $key => $value) { ?>
                                                                <option value="<?php echo $key ?>" <?php echo ($key == $notification_data['selection_type']) ? 'selected' : '' ?>><?php echo $value ?></option>
                                                        <?php }
                                                        } ?>
                                                    </select>
                                                    </div>
                                                ...
                                                <div class="row form-group user_div" style="<?php echo ($notification_data['selection_type'] == 'user') ? '' : 'display:none' ?>">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-7">
                                                        ...
                                                        <?php foreach ($notification_user_map as $user) {  ?>
                                                            <option value="<?= $user['user_id'] ?>" selected><?= $user['first_name']." ".$user['last_name']  ?></option>
                                                        <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row form-group realtor_div" style="<?php echo ($notification_data['selection_type'] == 'realtor') ? '' : 'display:none' ?>">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-7">
                                                        ...
                                                        <?php foreach ($notification_realtor_map as $user) {  ?>
                                                            <option value="<?= $user['realtor_id'] ?>" selected><?= $user['name']  ?></option>
                                                        <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div  class="col-md-6">
                                                    <input name="notification_id" placeholder="Enter Notification Title" type="hidden" value="<?php echo $notification_data['id'] ?>" class="form-control">
                                                        <input required name="notification_title" placeholder="Enter Notification Title" type="text" value="<?php echo $notification_data['notification_title'] ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                   <div class="col-md-2">
                                                    ...
                                                    <div  class="col-md-4">
                                                        <input accept="image/*" type="file" data-parsley-filetype="image" data-parsley-fileextension="jpg jpeg png" name="filePhoto" value="" id="filePhoto" class=" borrowerImageFile" data-errormsg="PhotoUploadErrorMsg">
                                                        <br/><br/>
                                                    ...
                                                    <div class="col-md-3" id="old">
                                                    <input type="hidden" name="uploaded_image" id="uploaded_image" value="<?php echo isset($notification_data['image']) ? $notification_data['image'] : ''; ?>" />
                                                            <?php if (isset($notification_data['image']) && $notification_data['image'] != '') { ?>
                                                                <span class="block"><?php echo "Seelected Image" ?></span>
                                                                <img id='oldpic' class="img-responsive" src="<?php echo base_url() . 'uploads/notification/' . $notification_data['image']; ?>">
                                                            <?php }  ?>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div  class="col-md-6">
                                                         ...
                                                         <?php echo $notification_data['notification_description'] ?>
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div  class="col-md-1">
                                                        <div class="form-check">
                                                                <input id="save" class="form-check-input" type="checkbox" name="save" value="1">
                                                        </div>
                                                    </div>
