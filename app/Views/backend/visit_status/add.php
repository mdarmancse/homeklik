                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Visit Status Add</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><i class="fas fa-tachometer-alt "></i><a href="<?php echo site_url('/') ?>" class="breadcrumb-link"> Dashboard</a></li>
                                        <li class="breadcrumb-item"><i class="fa fa-fw fa-building"></i><a href="<?php echo site_url('/task_status') ?>" class="breadcrumb-link">Visit Status</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Visit Status Add</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        Visit Status Add
                                    ...
                                    <div class="card-body">
                                        <form action="<?= base_url('visit_status/store') ?>" data-parsley-validate="" novalidate="" method="post">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-2">
                                                    <label style="font-size: 16px;" class="col-form-label"><b> Slug </b><span class="required">*</span></label>
                                                </div>
                                                <div  class="col-md-6">
                                                    <input required name="slug" placeholder="Enter  Slug" type="text" value="" class="form-control">
                                                </div>
                                            </div>
