...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Sale Property</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><i class="fas fa-tachometer-alt "></i><a href="<?php echo site_url('/') ?>" class="breadcrumb-link"> Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-fw fa-home"></i>Sale Property</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        Sale Property
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="sale_property_ajax" class="table table-success table-bordered second" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Sl</th>
                                                <th>User Name</th>
 ...
 <script>
    $(document).ready(function() {
        $('#sale_property_ajax').DataTable({
            'processing': true,
            'serverSide': true,
            'serverMethod': 'post',
            'dom' : 'bflrtip',
            ajax: {
                url: "<?php echo base_url('property/getSalePropertyAjaxData'); ?>",
                type: 'POST',
                // dataType: 'json',
                // dataSrc: ''
            },
